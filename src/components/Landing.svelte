...
<div class="lg:col-span-3">
    <p class="text-5xl lg:text-7xl xl:text-9xl text-center lg:text-center bg-clip-text text-transparent bg-gradient-to-r from-teal-500 to-emerald-900 -rotate-12">
        <b>Hello!</b>
    </p>
</div>
<div class="lg:col-span-4 text-center">
    ...
    <div class="avatar w-full transparent z-10">
