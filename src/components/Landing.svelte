...
<div class="modal-box">
  ...
  <p class="py-4">AI generated pic, so it's meself but not rly. Using this because this AI dude looks great.</p>
</div>
...
<div class="lg:col-span-3"><p class="text-5xl lg:text-7xl xl:text-9xl text-center lg:text-center bg-clip-text text-transparent bg-gradient-to-r from-teal-500 to-emerald-900"><b>Hello!<br>您好！</b></p></div>
...
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100px" height="100px" x="0px" y="0px"
	 viewBox="0 0 302.816 302.816" style="enable-background:new 0 0 302.816 302.816;" xml:space="preserve" class="arrow-svg">
<path fill="#064e3b" id="XMLID_2_" d="M241.053,78.136c0.01-0.224,0.031-0.448,0.03-0.672c0-0.345-0.024-0.686-0.049-1.027
...
<div class="lg:col-span-5">
    ...
    <div>
        <p class="text-2xl lg:text-4xl xl:text-5xl mb-2">At work, I'm a <button class="rounded-full btn btn-accent text-2xl lg:text-4xl xl:text-5xl"><a href="#experience">public servant</a></button></p>
        <p class="text-xl lg:text-2xl xl:text-3xl mb-10 ms-[4rem] text-gray-600"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-corner-down-right inline" width="35" height="35" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M6 6v6a3 3 0 0 0 3 3h10l-4 -4m0 8l4 -4" /></svg> I do <b>digitalization</b> and <b>digital products</b>.</p>
    </div>
    <div>
        <p class="text-2xl lg:text-4xl xl:text-5xl mb-2">At home, I'm <span class="rounded-full btn btn-accent text-2xl lg:text-4xl xl:text-5xl"><a href="#projects">webdev wannabe</a></span></p>
        <p class="text-xl lg:text-2xl xl:text-3xl mb-6 ms-[4rem] text-gray-600"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-corner-down-right inline" width="35" height="35" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M6 6v6a3 3 0 0 0 3 3h10l-4 -4m0 8l4 -4" /></svg> I enjoy developing <b>web apps</b>.</p>
    </div>
    </div>
</div>
</div>
...
<style>
    ...
    .arrow-svg {
        transform: rotate(160deg) translateY(-0.8em) translateX(-1.5em);
    }
</style>