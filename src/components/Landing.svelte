...
<div class="grid grid-cols-1 lg:grid-cols-12 items-center w-full px-7 h-full">
    <div class="lg:col-span-5 avatar justify-self-center w-96 h-96">
        <div class="rounded-full">
            <a href=""><img src={profilepic} class="object-scale-down object-center" alt="AI generated, so it's me but not rly." on:click={() => {my_modal_2.showModal()}}></a>
        </div>
    </div>
    <div class="lg:col-span-7">
        <p class="mb-12 text-5xl">Hello, I'm <b>Zixian</b>.</p>
        ...
        <div class="divider divider-base-200 w-3/6 my-8"></div>
