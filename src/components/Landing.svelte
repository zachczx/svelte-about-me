...
<div class="lg:col-span-3"><p class="text-5xl text-center lg:text-center bg-clip-text text-transparent bg-gradient-to-r from-teal-500 to-emerald-900">Hello,<br> I'm <b>Zixian</b>.</p></div>
